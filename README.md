...
<div align="center">
  ...
  <p align="center">
    A conversation chatbot to serve information related to RSSB!
    <br />
...
This section should list of all the packages and frameworks used to develop the chatbot.
...
1. Clone the repo
   ```sh
   git clone https://github.com/GSinseswa721/Gloria-chatbot-huzalabs.git
   ```
2. Go into the directory
   ```sh
   cd Gloria-chatbot-huzalabs
   ```
...
<!-- USAGE EXAMPLES -->
## Usage
After running the gunicorn command oprn your browser at http://127.0.0.1/5000 to interact with the chatbot.
...
Gloria - [@LinkedIn](https://www.linkedin.com/in/gloria-niyonkuru-sinseswa-4a1b9b196/) - glorianiyonkurusinseswa@gmail.com
